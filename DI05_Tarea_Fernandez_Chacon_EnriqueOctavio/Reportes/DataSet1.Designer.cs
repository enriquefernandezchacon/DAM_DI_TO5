...
namespace DI05_Tarea_Fernandez_Chacon_EnriqueOctavio.Reportes {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientesRow AddClientesRow(string nombre, string apellidos, string email, string telefono) {
...
namespace DI05_Tarea_Fernandez_Chacon_EnriqueOctavio.Reportes.DataSet1TableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Clientes] WHERE (([id] = @Original_id) AND ([nombre] = @Original_nom" +
                "bre) AND ([apellidos] = @Original_apellidos) AND ([email] = @Original_email) AND" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Clientes] ([nombre], [apellidos], [email], [telefono]) VALUES (@nomb" +
                "re, @apellidos, @email, @telefono);\r\nSELECT id, nombre, apellidos, email, telefo" +
                "no FROM Clientes WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Clientes] SET [nombre] = @nombre, [apellidos] = @apellidos, [email] = @email, [telefono] = @telefono WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ([apellidos] = @Original_apellidos) AND ([email] = @Original_email) AND ([telefono] = @Original_telefono));
SELECT id, nombre, apellidos, email, telefono FROM Clientes WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=localhost;Initial Catalog=clinica;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, nombre, apellidos, email, telefono\r\nFROM            Clientes";
        ...
        public virtual int Delete(int Original_id, string Original_nombre, string Original_apellidos, string Original_email, string Original_telefono) {
        ...
        public virtual int Update(string nombre, string apellidos, string email, string telefono, int Original_id, string Original_nombre, string Original_apellidos, string Original_email, string Original_telefono, int id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string apellidos, string email, string telefono, int Original_id, string Original_nombre, string Original_apellidos, string Original_email, string Original_telefono) {
            return this.Update(nombre, apellidos, email, telefono, Original_id, Original_nombre, Original_apellidos, Original_email, Original_telefono, Original_id);
        }
    }
